defmodule PersonalBoardV2Web do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: PersonalBoardV2Web
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/personal_board_v2_web/templates",
        namespace: PersonalBoardV2Web
